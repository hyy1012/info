        ...
        <div class="layui-row">
            <div class="layui-col-md12">
                ...
                <div class="demoTable" style="margin-top: 10px;">
                    ...
                    <button class="layui-btn addNew">添加员工</button>
                </div>
    ...
    layui.config({
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'aJnum', width: 80, title: '工号', sort: true}
                , {field: 'sex', width: 80, title: '性别', templet: '#sex_', sort: true}
                , {field: 'depart', width: 100, title: '部门'}
                , {field: 'aStatus', width: 130, title: '职位',templet: function (d) {
                        if (d.aStatus == 4) {
                            return "正式员工"
                        }else if (d.aStatus == 5) {
                            return "部门经理"
